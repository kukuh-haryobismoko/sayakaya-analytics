...
function looksLikeActivityLogQuestion(question) {
...
function activityLogFilterPrompt() {
...
async function questionToActivityLogFilter(question) {
  const key = process.env.ANTHROPIC_API_KEY;
...
async function answerActivityLog(question) {
