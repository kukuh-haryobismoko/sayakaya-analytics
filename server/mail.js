...
async function sendInviteEmail({ to, activateUrl }) {
...
const KIND_LABEL = { statement: 'Send statement', fund_performance: 'Send fund performance' };
async function sendScheduleOtpEmail({ to, code, kind }) {
...
module.exports = { sendStatementEmail, sendPasswordResetEmail, sendInviteEmail, sendScheduleOtpEmail };
